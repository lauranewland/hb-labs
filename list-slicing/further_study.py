...
def custom_insert(input_list, index, value):
    ...
    """
    input_list.insert(index,value) #Need to do
    pass
...
def custom_remove(input_list, value):
    ...
    """
    input_list.remove(value) #Need to do
    pass
...
def custom_index(input_list, value):
    ...
    return input_list.index(value) #Need to do
...
def custom_count(input_list, value):
    ...
    return input_list.count(value)#Need to do
...
def custom_equality(some_list, another_list):
    ...
    return some_list == another_list #Need to do
